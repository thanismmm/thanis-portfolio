    ...
    <div className="container-section min-h-[84vh] grid place-items-center relative overflow-hidden">
      ...
      >
        ...
        <div className="mt-8 flex items-center justify-center gap-3">
          ...
          <a target='_blank' href="images/thanis-webcv-qatar.pdf" className="px-5 py-3 rounded-lg border border-slate-300 dark:border-slate-700 hover:bg-slate-100 dark:hover:bg-slate-900 transition-colors" download="thanis-webcv-qatar.pdf">Download Resume</a>
        </div>
      </motion.div>
    </div>
  );
